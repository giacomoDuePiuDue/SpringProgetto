...
public class DipendenteService {
	...
	//------------esecizio 1------------
	public List<DipendenteDto> esercizio_1(String dataInizio,String dataFine,String skill)
	{
		List<Dipendente> dipendenti=dipendenteRepository.esercizio_1(dataInizio,dataFine,skill);
	...
	{
		dipendenteRepository.esercizio_4(id_dipendente);
	}
}
